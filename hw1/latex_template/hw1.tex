...
\newcommand{\outDate}{Monday, January 13th}
\newcommand{\dueDate}{Wednesday, January 22nd}
\newcommand{\taNames}{}
...
\begin{parts}
    ...
    \part[1] \sone You may use grace days on HW1.
...
def fib_2(n):
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.6\textwidth]{figs/BritiansRoyalFamily.jpg}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width = 0.4\textwidth]{figs/TreePlot.png}
...
\begin{figure}[ht]
\centering
\includegraphics[scale=0.37]{figs/grid_memoize.png}
\caption{}
...
% \documentclass[11pt,addpoints,answerss]{exam}
...
% \input{hw1_instructions.tex}
% \clearpage

% \input{../shared/instructions_for_specific_problem_types.tex}
% \clearpage

% \input{majority-vote.tex}
% \clearpage

% {\LARGE \bf Written Questions (\numpoints \ points)}
% \begin{questions}
% \input{course-policy.tex}
% \clearpage
% \newpage
% \input{prob-stat.tex}
% \clearpage 
